...
Button profile, settings, volunteer, alert, pmcare, goafund, hospital, contact, preventive;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        goafund.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new AlertDialog.Builder(home.this)
                        .setTitle("Rajasthan State COVID-19 Relief Fund.")
                        .setMessage("You will be redirected to the official payment link of Rajasthan State COVID-19 Relief Fund. Do you want to continue?")
                        .setPositiveButton("Continue", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                // Continue with COVID-19 goa relief fund
                                Uri uriUrl = Uri.parse("https://www.rsmp.rajasthan.gov.in/covid19-cmrf/");
                                Intent launchBrowser = new Intent(Intent.ACTION_VIEW, uriUrl);
                                startActivity(launchBrowser);
                            }
                        })
